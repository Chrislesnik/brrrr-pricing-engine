          ...
          <span
            ...
            style={{
              ...
              border: "1px dashed #f59e0b",
                  color: "inherit",
                  // maintain the same row padding/height as regular text
                  padding: "0",
                  borderRadius: 3,
                  minWidth: 28,
                  lineHeight: "inherit",
...
const BridgeTermSheet = (props: BridgeTermSheetProps): React.ReactElement => {
  ...
  const extraRows = [
    ...
    { label: asText(props, "extra_row_8_label"), value: asText(props, "extra_row_8") },
  ...
  return (
    <div data-termsheet-root="bridge" className="overflow-x-hidden w-full min-w-[816px] h-[1056px] flex items-center justify-center bg-white text-black">
