...
const BridgeTermSheet = (props: BridgeTermSheetProps): React.ReactElement => {
  ...
  const extraRows = [
    ...
    { label: asText(props, "extra_row_6_label"), value: asText(props, "extra_row_6") },
    { label: asText(props, "extra_row_7_label"), value: asText(props, "extra_row_7") },
  ]
  ...
  return (
    <div className="overflow-x-hidden w-full min-w-[816px] min-h-[1056px] h-full flex items-center justify-center bg-white text-black">
      {/* Reduce page padding to 'zoom out' slightly */}
      <div className="w-[816px] max-w-none p-3 relative print:p-2">
            ...
            <div className="px-3 pt-3 pb-0 flex flex-col">
              ...
              <div className="border-2 border-solid border-black mb-2 mx-[-12px]">
                <div className="px-2">
                  ...
                  <div className="bg-black text-white py-1 px-4 mb-1 -mx-2">
                  ...
                  <div className="bg-[#808080] text-white py-1 px-4 -mx-2 border-t-2 border-l-0 border-r-0 border-b-0 border-solid border-black">
