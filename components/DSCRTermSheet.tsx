            ...
            <div className="flex flex-col flex-1">
              ...
              <div className="border-2 border-black mb-2">
                <div className="px-2 h-6" style={{ backgroundColor: "#000000", color: "#ffffff", display: "grid", alignItems: "center" }}>
                  <h3 className="text-sm font-bold italic m-0" style={{ paddingLeft: 8, textAlign: "left", transform: "translateY(-8px)" }}>CREDITS</h3>
                </div>
              ...
              <div className="border-2 border-black flex flex-col flex-1">
                <div className="px-2 h-6" style={{ backgroundColor: "#000000", color: "#ffffff", display: "grid", alignItems: "center" }}>
                  <h3 className="text-sm font-bold italic m-0" style={{ paddingLeft: 8, textAlign: "left", transform: "translateY(-8px)" }}>DEBITS</h3>
                </div>
