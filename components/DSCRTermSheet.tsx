    ...
    >
      <div className="w-[816px] max-w-none print:w-[816px] px-7" style={{ boxSizing: "border-box", outline: "4px solid #f59e0b", outlineOffset: "0px" }}>
          ...
          <section className="flex flex-col h-full flex-1">
            <div className="flex flex-col flex-1">
              ...
              <div className="border-2 border-black mb-2">
                <div className="px-2 h-6 relative" style={{ backgroundColor: "#000000", color: "#ffffff" }}>
                  <h3 className="text-sm font-bold italic m-0" style={{ position: "absolute", top: "50%", transform: "translateY(-50%)", left: "8px" }}>CREDITS</h3>
                </div>
              ...
              <div className="border-2 border-black flex flex-col flex-1">
                <div className="px-2 h-6 relative" style={{ backgroundColor: "#000000", color: "#ffffff" }}>
                  <h3 className="text-sm font-bold italic m-0" style={{ position: "absolute", top: "50%", transform: "translateY(-50%)", left: "8px" }}>DEBITS</h3>
                </div>
        ...
        <footer className="mt-6">
          <p className="text-[8px]" style={{ lineHeight: "8px" }}>
