...
const CartStep = ({ data, stepper }: { data: OrderItemType[]; stepper: StepperType }) => {
  ...
  const [pullType, setPullType] = useState<'hard' | 'soft'>('hard')
  ...
  return (
    <div className='grid grid-cols-1 gap-6 lg:grid-cols-3'>
      <div className='flex flex-col gap-6 lg:col-span-2'>
        <div className='flex flex-col gap-6 overflow-y-auto pr-2 max-h-[65vh]'>
          {isCredit ? (
            <>
      ...
      <div className='flex flex-col gap-6'>
        ...
        <ChatPanel className='rounded-md border p-4 h-[548px]' />
      </div>
    </div>
  )
}
