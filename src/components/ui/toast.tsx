...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "text-foreground/50 hover:text-foreground absolute top-1 right-1 rounded-md p-1 opacity-0 transition-opacity group-hover:opacity-100 group-[.destructive]:text-destructive-foreground/70 hover:group-[.destructive]:text-destructive-foreground focus:opacity-100 focus:ring-1 focus:outline-hidden focus:group-[.destructive]:ring-destructive focus:group-[.destructive]:ring-offset-destructive",
      className
    )}
    toast-close=""
    {...props}
