...
function ResultCard({
  ...
  const renderPreviewToPdf = async (): Promise<File | null> => {
    ...
    style.textContent = `
      ...
      /* Bridge PDF-only: move CREDITS list content up by 10px */
      .pdf-sandbox [data-termsheet-root=\"bridge\"] .border-2.border-solid.border-black.mb-2 > .px-2 > .mb-0 { position: relative !important; top: -10px !important; }
