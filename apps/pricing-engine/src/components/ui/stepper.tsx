...
function StepperTrigger({ asChild = false, className, children, tabIndex, ...props }: StepperTriggerProps) {
  ...
  return (
    <button
      ...
      data-state={state}
      className={cn('inline-flex items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-md', className)}
...
function StepperSeparator({ className }: React.ComponentProps<'div'>) {
  ...
  return (
    <div
      data-state={state}
      className={cn(
        'h-0.5 flex-1 rounded-full bg-muted-foreground/20 transition-colors data-[state=completed]:bg-primary',
        className,
      )}
    />
  );
...
function StepperTitle({ children, className }: React.ComponentProps<'h3'>) {
  ...
  return (
    <h3
      data-state={state}
      className={cn('text-sm font-medium transition-colors data-[state=active]:text-foreground data-[state=inactive]:text-muted-foreground', className)}
    >
      {children}
    </h3>
  );
