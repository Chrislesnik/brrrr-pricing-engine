...
import { useIsMobile } from "@/components/workflow-builder/hooks/use-mobile";
import { api, type Integration } from "@/components/workflow-builder/lib/api-client";
import { getIntegration, getIntegrationLabels } from "@/components/workflow-builder/plugins";
