...
import { AUTO_GENERATED_TEMPLATES } from "@/components/workflow-builder/lib/codegen-registry";
import conditionTemplate from "@/components/workflow-builder/lib/codegen-templates/condition";
import databaseQueryTemplate from "@/components/workflow-builder/lib/codegen-templates/database-query";
import httpRequestTemplate from "@/components/workflow-builder/lib/codegen-templates/http-request";
