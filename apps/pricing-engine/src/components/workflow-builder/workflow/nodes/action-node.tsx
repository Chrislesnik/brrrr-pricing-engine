...
import {
  ...
  NodeDescription,
  NodeTitle,
} from "@/components/workflow-builder/ai-elements/node";
...
import { findActionById, getIntegration } from "@/components/workflow-builder/plugins";
  ...
  return (
    <>
      ...
      <Dialog onOpenChange={setDialogOpen} open={dialogOpen}>
        <DialogContent className="max-w-3xl p-2" hideClose>
