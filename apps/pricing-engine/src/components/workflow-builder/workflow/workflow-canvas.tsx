...
import { Canvas } from "@/components/workflow-builder/ai-elements/canvas";
import { Connection } from "@/components/workflow-builder/ai-elements/connection";
import { Controls } from "@/components/workflow-builder/ai-elements/controls";
import { AIPrompt } from "@/components/workflow-builder/ai-elements/prompt";
import { WorkflowToolbar } from "@/components/workflow-builder/workflow/workflow-toolbar";
...
export function WorkflowCanvas() {
  ...
  const panOnDrag = useAtomValue(panOnDragAtom);
  ...
  return (
    <div
      className="relative h-full min-w-0 flex-1 bg-muted/40 dark:bg-background"
    ...
    >
      ...
      >
        ...
        {showMinimap && (
          <MiniMap bgColor="var(--muted)" nodeStrokeColor="var(--border)" />
        )}
      </Canvas>
