        ...
        <Button
          ...
          className={cn(
            ...
            variant === "default"
              ...
              : "border-sidebar-border bg-sidebar-accent/10 text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-sidebar-ring md:w-full lg:w-full xl:w-full",
