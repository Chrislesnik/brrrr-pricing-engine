                        ...
                        <>
                          <TableRow className="bg-muted/30">
                            <TableCell
                              ...
                              className="p-0"
                            >
                              <div className="text-muted-foreground grid grid-cols-4 gap-4 px-6 py-2 text-[11px] font-semibold uppercase">
                                <span>Name</span>
                                <span>Role</span>
                          ...
                          {membersMap[orgId]?.map((member) => (
                            ...
                            >
                              <TableCell
                                ...
                                className="p-0"
                              >
                                <div className="grid grid-cols-4 items-center gap-4 px-6 py-2 text-sm">
