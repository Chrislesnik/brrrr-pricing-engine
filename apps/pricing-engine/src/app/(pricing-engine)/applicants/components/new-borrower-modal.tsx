...
export function NewBorrowerModal({
  ...
  const [dobCalMonth, setDobCalMonth] = useState<Date | undefined>(
    new Date(2000, 0, 1)
  )
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        ...
        if (!active) return
        const id =
          typeof j?.self_member_id === "string" ? j.self_member_id : null
  ...
  useEffect(() => {
    if (!isImmigrationRelevant) {
      setValue("green_card", undefined as any, {
  ...
  useEffect(() => {
    if (!isVisaRelevant) {
      setValue("visa", undefined as any, {
        shouldValidate: false,
        shouldDirty: true,
      })
      setValue("visa_type", undefined as any, {
        shouldValidate: false,
        shouldDirty: true,
      })
    }
  ...
  const onSubmit = async (vals: FormValues) => {
    ...
    const payload = {
      ...
      date_of_birth: vals.date_of_birth
        ? formatLocalYYYYMMDD(vals.date_of_birth)
        : undefined,
                    ...
                    <div className="relative">
                      <Input
                        ...
                        onKeyDown={(e) => {
                          ...
                          if (allowed.includes(e.key) || e.metaKey || e.ctrlKey)
                            return
                          if (!/^[0-9]$/.test(e.key)) {
                            e.preventDefault()
                          }
                      ...
                      <PopoverTrigger asChild>
                        <div className="relative">
                          <DateInput
                            ...
                            value={dob}
                            onChange={(d) =>
                              setValue("date_of_birth", d ?? undefined)
                            }
                          />
                          {/* Calendar icon */}
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <Input
                    ...
                    value={primaryPhone ?? ""}
                    onChange={(e) =>
                      setValue("primary_phone", formatUS(e.target.value), {
                        shouldDirty: true,
                        shouldValidate: false,
                      })
                    }
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <Input
                    ...
                    value={altPhone ?? ""}
                    onChange={(e) =>
                      setValue("alt_phone", formatUS(e.target.value), {
                        shouldDirty: true,
                        shouldValidate: false,
                      })
                    }
            ...
            <section>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="flex flex-col gap-1">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Non-Permanent Resident">
                        Non-Permanent Resident
                      </SelectItem>
                ...
                <div
                  className={cn(
                    "flex flex-col gap-1",
                    !isImmigrationRelevant ? "opacity-60" : ""
                  )}
                >
                  ...
                  >
                    <SelectTrigger disabled={!isImmigrationRelevant}>
                      <SelectValue
                        placeholder={!isImmigrationRelevant ? "N/A" : "Select"}
                      />
                    </SelectTrigger>
                    <SelectContent>
                ...
                >
                  ...
                  >
                    <SelectTrigger disabled={!isVisaRelevant}>
                      <SelectValue
                        placeholder={!isVisaRelevant ? "N/A" : "Select"}
                      />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="Yes">Yes</SelectItem>
                ...
                >
                  ...
                  >
                    <SelectTrigger disabled={!isVisaTypeEnabled}>
                      <SelectValue
                        placeholder={
                          !isVisaTypeEnabled ? "N/A" : "Select VISA type"
                        }
                      />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="CW1">CW1</SelectItem>
                      <SelectItem value="E-1 / E-2 / E-3">
                        E-1 / E-2 / E-3
                      </SelectItem>
                    </SelectContent>
                  </Select>
              ...
              <div className="grid gap-3">
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                  <div className="flex flex-col gap-1">
                    ...
                    <NumberField
                      value={
                        watch("rentals_owned")
                          ? Number(watch("rentals_owned"))
                          : undefined
                      }
                      onChange={(val) =>
                        setValue("rentals_owned", val, { shouldDirty: true })
                      }
                      minValue={0}
                      className="w-full"
                    >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <NumberField
                      value={
                        watch("fix_flips_3yrs")
                          ? Number(watch("fix_flips_3yrs"))
                          : undefined
                      }
                      onChange={(val) =>
                        setValue("fix_flips_3yrs", val, { shouldDirty: true })
                      }
                      minValue={0}
                      className="w-full"
                    >
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                  <div className="flex flex-col gap-1">
                    ...
                    <NumberField
                      value={
                        watch("groundups_3yrs")
                          ? Number(watch("groundups_3yrs"))
                          : undefined
                      }
                      onChange={(val) =>
                        setValue("groundups_3yrs", val, { shouldDirty: true })
                      }
                      minValue={0}
                      className="w-full"
                    >
                ...
                <div className="flex flex-col gap-1">
                  <Label>
                    Are you a licensed General Contractor, Real Estate Broker /
                    Sales Person, Lender, Appraiser or involved in any other
                    real estate related activities?
                  </Label>
                  <Select
                    value={(watch("real_estate_licensed") as any) ?? undefined}
                    onValueChange={(v) =>
                      setValue("real_estate_licensed", v as any)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Select" />
