...
VALUES
  ...
  ('document_files_clerk_users', NULL, 'clerk_user_id', 'pk', NULL, false, 'Bigint FK to users.id; also has created_by'),
  ('document_files_entities', NULL, 'created_by', 'clerk_id', NULL, false, NULL),
  ('document_files_tags', NULL, 'created_by', 'pk', NULL, false, 'Bigint FK to users.id'),
  ('document_tags', NULL, 'created_by', 'pk', NULL, false, 'Bigint FK to users.id'),
