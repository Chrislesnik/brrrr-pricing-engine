...
CREATE TABLE IF NOT EXISTS "public"."xactus_reports" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "borrower_id" "uuid",
    "raw_data" "text",
    "cleaned_data" json,
...
ALTER TABLE "public"."xactus_reports" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."xactus_reports"
...
ALTER TABLE "public"."xactus_reports" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."xactus_reports" TO "anon";
GRANT ALL ON TABLE "public"."xactus_reports" TO "authenticated";
GRANT ALL ON TABLE "public"."xactus_reports" TO "service_role";
